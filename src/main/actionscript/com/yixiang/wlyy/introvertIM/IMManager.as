	...
	public class IMManager extends EventDispatcher
	{
		...
		*/
		...
		public function set status(newStatus:IMStatus):void
		{
			...
			ExternalInterface.call("$S.statusChange");
		}
		...
		public function hasReady():void{
			dispatchEvent(new IMReadyEvent(IMReadyEvent.APP_READY, true));
		}
		...
		{
			var result:Boolean = ExternalInterface.call("$S.isReady");
			Message.showDebugMessage("JS is ready: " + result.toString());
			return result;
		}
		...
		private function setupCallbacks():void
		{
			...
			ExternalInterface.addCallback("allReadyToGo", allReadyToGo);
			// notify the container that the SWF is ready to be called.
			ExternalInterface.call("$S.setSWFIsReady");
			
			
		}
		
		public function allReadyToGo():void{
			Message.showDebugMessage("All Ready: Go!");
			dispatchEvent(new IMReadyEvent(IMReadyEvent.APP_READY, true));
		}
